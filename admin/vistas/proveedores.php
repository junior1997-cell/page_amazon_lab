                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-lg-12 tabla" style="display: none;">
                        <!-- tabla -->
                        <table id="tabla-proveedor" class="table table-bordered table-striped display" style="width: 100% !important;">
                          <thead>
                            <tr>
                              <th class="">Acc.</th>
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title"><b>Agregar:</b> Proveedor</h4>
                ...
                <div class="modal-body">
                  <!-- form start -->
                  <form id="form-proveedores" name="form-proveedores" method="POST">
                    <div class="card-body">
                      <div class="row" id="cargando-1-fomulario">
                        ...
                        <div class="col-lg-12">
                          <div class="form-group selectt">
                            <label for="id_proveedor_adm" class="cargando__">Proveedor <i class="fas fa-spinner fa-pulse fa-lg text-danger"></i></label>                               
                            <select name="id_proveedor_adm" id="id_proveedor_adm"
                          ...
                          <div class="form-group edith">
                            <label for="proveedor">Proveedor <sup class="text-danger">*</sup></label>
                            <input type="text" class="form-control selec_proveedor_adm " placeholder="Proveedor" readonly />
                            <input type="hidden" class="form-control id_proveedor_adm_edith" id="id_proveedor_adm_edith" name="id_proveedor_adm_edith" />
                          </div>
                    ...
                    <!-- /.card-body -->
                    <button type="submit" style="display: none;" id="submit-form-proveedores">Submit</button>
                  </form>
                </div>
